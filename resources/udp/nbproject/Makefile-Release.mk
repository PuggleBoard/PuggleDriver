...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/dg_client.o \
	${OBJECTDIR}/dg_server.o \
	${OBJECTDIR}/main.o
...
${OBJECTDIR}/dg_client.o: dg_client.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dg_client.o dg_client.c

${OBJECTDIR}/dg_server.o: dg_server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dg_server.o dg_server.c
