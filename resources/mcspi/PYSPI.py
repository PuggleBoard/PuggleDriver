...
class SPI_SETUP():
    ...
    @staticmethod    
    def setCH_CONF(CLKG = 0x1, FFER = 0x0, FFEW = 0x0, TCS = 0x0, SBPOL = 0x0, SBE = 0x0, SPIENSLV = 0x0, FORCE = 0x0, TURBO = 0x0, IS = 0x1, DPE1 = 0x1, DPE0 = 0x0, DMAR = 0x0, DMAW = 0x0, TRM = 0x0, WL = 0x4, EPOL = 0x1, CLKD = 0x2, POL = 0x0, PHA = 0x1):
        """
